                        ...
                        .map((session) => (
                          <div
                            ...
                            className={`w-10 h-10 rounded-lg flex items-center justify-center text-xs font-medium ${
                              session.attended ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"
                            }`}
            ...
            <div className="flex items-center gap-4">
              <div
                className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-colors ${
                  attendanceStatus ? "border-green-500 bg-green-50" : "border-muted hover:border-muted-foreground/50"
                }`}
              ...
              <div
                className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-colors ${
                  !attendanceStatus ? "border-red-500 bg-red-50" : "border-muted hover:border-muted-foreground/50"
                }`}
