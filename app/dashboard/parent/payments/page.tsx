...
import { Wallet, CreditCard, Clock, CheckCircle, AlertCircle, Search, Download, Plus } from "lucide-react"
...
export default function ParentPaymentsPage() {
  ...
  const confirmPayment = () => {
    ...
    // POST /api/payments with payment details
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{pendingPayments.length} khoản đang chờ</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
      ...
      <Tabs defaultValue="pending" className="space-y-4">
        <TabsList>
          <TabsTrigger value="pending" className="gap-2">
            ...
            Cần thanh toán ({pendingPayments.length})
          </TabsTrigger>
      ...
      <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Chọn phương thức thanh toán cho học phí</DialogDescription>
          </DialogHeader>
          {selectedPayment && (
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <Select defaultValue="wallet">
                  ...
                  <SelectContent>
                    <SelectItem value="wallet">Ví EduConnect (5,000,000đ)</SelectItem>
