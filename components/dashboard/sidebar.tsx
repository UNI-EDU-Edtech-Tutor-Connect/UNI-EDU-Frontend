...
const navItemsByRole: Record<UserRole, NavItem[]> = {
  ...
  tutor: [
    ...
    { title: "Lịch rảnh", href: "/dashboard/tutor/availability", icon: Clock },
    { title: "Học sinh", href: "/dashboard/tutor/students", icon: Users },
    { title: "Ví điện tử", href: "/dashboard/tutor/wallet", icon: Wallet },
  ...
  teacher: [
    ...
    { title: "Lịch rảnh", href: "/dashboard/teacher/availability", icon: Clock },
    { title: "Học sinh", href: "/dashboard/teacher/students", icon: Users },
    { title: "Ví điện tử", href: "/dashboard/teacher/wallet", icon: Wallet },
  ...
  student: [
    ...
    { title: "Lịch rảnh", href: "/dashboard/student/availability", icon: Clock },
    { title: "Bài test", href: "/dashboard/student/tests", icon: FileCheck },
    { title: "Thi thử", href: "/dashboard/student/practice", icon: TestTube },
    { title: "Ví học phí", href: "/dashboard/student/wallet", icon: Wallet },
  ...
  parent: [
    ...
    { title: "Ví & Thanh toán", href: "/dashboard/parent/wallet", icon: Wallet },
  ],
  accountant: [
  ...
  office: [
    ...
    { title: "Xếp lịch tự động", href: "/dashboard/office/auto-schedule", icon: Calendar },
    { title: "Lịch sự kiện", href: "/dashboard/office/calendar", icon: Calendar },
